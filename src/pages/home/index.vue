<template>
  <div ref="page" class="page">
    <img
      ref="bgimg"
      src="//api.dujin.org/bing/1920.php"
      style="display: none"
    />
    <header ref="header">
      <hgroup>
        <div class="avatar">
          <img src="../../assets/logo.gif" id="play_bgm_avatar" />
        </div>
        <div class="sitename">
          <h1>
            <span>张张</span>
    ...
    <nav>
      <ul class="main-nav">
        <li title="文章">
          <a
            class="blog"
            onclick="_hmt.push(['_trackEvent', 'nav', 'click', '文章'])"
            href="https://blog.zhangbing.site/"
          >
            <i class="iconfont icon-article1"></i> 文章
          </a>
        </li>
        <li title="Vue3备忘单">
          <a
            class="store"
            onclick="_hmt.push(['_trackEvent', 'nav', 'click', 'Vue3备忘单'])"
            href="/vue3/"
          >
            <svg
        ...
        <li title="我的小商店">
          <a
            class="store"
            onclick="_hmt.push(['_trackEvent', 'nav', 'click', '小商店'])"
            href="https://store.zhangbing.site"
          >
        ...
        <li title="小码">
          <a
            class="demo"
            onclick="_hmt.push(['_trackEvent', 'nav', 'click', 'DEMO'])"
            href="https://coding.zhangbing.site"
          >
            <i class="iconfont icon-Code"></i> 小码
          </a>
        </li>
        <li title="看世界">
          <a
            class="map"
            onclick="_hmt.push(['_trackEvent', 'nav', 'click', '看世界'])"
            href="#my-zuji"
          >
        ...
        <li title="读书记录">
          <a
            class="read"
            onclick="_hmt.push(['_trackEvent', 'nav', 'click', '读书'])"
            href="https://book.douban.com/people/dunish/collect"
            target="_blank"
          >
            <i class="iconfont icon-book1"></i> 读书
          </a>
        </li>
        <li title="订阅">
          <a
            class="code"
            onclick="_hmt.push(['_trackEvent', 'nav', 'click', 'Code'])"
            href="#rss"
          >
            <i class="iconfont icon-RSS"></i> 订阅
          </a>
        </li>
        <li title="关于">
          <a
            class="about"
            onclick="_hmt.push(['_trackEvent', 'nav', 'click', '关于我'])"
            href="https://blog.zhangbing.site/about/"
          >
            <i class="iconfont icon-about-s"></i> 关于
          </a>
        </li>
      </ul>
      <ul class="sub-nav">
        ...
        <li>
          <a href="https://blog.zhangbing.site/tags/%E5%AE%9E%E6%88%98/"
            >实战</a
          >
        </li>
        <li>
        ...
        <li>
          <a
            href="https://blog.zhangbing.site/tags/%E5%B0%8F%E7%A8%8B%E5%BA%8F/"
            >微信小程序</a
          >
        </li>
        <li>
          <a
            href="https://blog.zhangbing.site/tags/%E5%B0%8F%E6%8A%80%E5%B7%A7/"
            >小技巧</a
          >
        </li>
        <li>
          <a href="https://blog.zhangbing.site/categories/%E5%B7%A5%E5%85%B7/"
            >工具</a
          >
        </li>
      </ul>
    ...
    <div class="row-container">
      <div class="row grid-30-70">
        ...
        <div class="row_box row_zhuanlan">
          <div class="header">
            <div class="title">
              <i class="iconfont icon-Rss"></i> 我的订阅推荐
            </div>
          ...
          <div class="content">
            <div class="content_img_box">
              <img
                src="https://i.loli.net/2019/12/11/cUMF7l35iORhenq.jpg"
                loading="lazy"
              />
              <a
                class="chenghao"
                onclick="_hmt.push(['_trackEvent', '专栏', 'click', '极客时间《白话法律42讲》'])"
                href="https://time.geekbang.org/column/intro/132"
                target="_blank"
              >
            ...
            <div class="content_img_box">
              <img
                src="//i.loli.net/2019/07/28/5d3d93b71d2da94904.png"
                loading="lazy"
              />
              <a
                class="xiangshuai"
                onclick="_hmt.push(['_trackEvent', '专栏', 'click', '《吴军的谷歌方法论》'])"
                href="javascript:;"
                target="_blank"
              >
                <i class="iconfont icon-webclicksettings"></i>
            ...
            <div class="content_img_box">
              <img
                src="https://i.loli.net/2020/03/15/nbMrts12OPaL68D.png"
                loading="lazy"
              />
              <a
                class="lixiaolai"
                onclick="_hmt.push(['_trackEvent', '专栏', 'click', '得到《香帅的北大金融学课》'])"
                href="javascript:;"
                target="_blank"
              >
                <i class="iconfont icon-webclicksettings"></i>
          ...
          <div class="content">
            <div class="row_store_item">
              <div class="item">
                <div class="item_img">
                  <img
                    src="https://m.360buyimg.com/mobilecms/s750x750_jfs/t1/112434/39/2947/421396/5ea4f421Ef5bbd571/2afe56af05a1fdf0.jpg"
                    loading="lazy"
                  />
                  <a
                    class="iconfont icon-icon-buy1"
                    href="https://store.zhangbing.site"
                    target="_blank"
                  >
                ...
                <a
                  class="info"
                  nclick="_hmt.push(['_trackEvent', '版块', 'click', '进入商店'])"
                  href="https://store.zhangbing.site"
                  target="_blank"
                >
                  <div class="buy_link">
                    <a
                      class="iconfont icon-webclicksettings"
                      href="https://store.zhangbing.site"
                      target="_blank"
                      >￥29，去看看</a
                    >
              ...
              <div class="item">
                <div :class="{ item_img: true, loading: showImgLoading }">
                  <img
                    src="http://m.360buyimg.com/mobilecms/s750x750_jfs/t1/110771/24/17861/176433/5f3b9c72E8881e1e1/d55b7a7baed69a9a.jpg!q80.dpg"
                    loading="lazy"
                  />
                  <a
                    class="iconfont icon-icon-buy1"
                    onclick="_hmt.push(['_trackEvent', '版块', 'click', '进入商店'])"
                    href="https://store.zhangbing.site"
                    target="_blank"
                  >
          ...
          <div class="content">
                ...
                <li>
                  <a href="https://segmentfault.com/lives" target="_blank">
                    <img
                      ...
                      alt="思否编程"
                      style="width: 140px"
                      src="https://ftp.bmp.ovh/imgs/2019/11/75e029021c8108fe.png"
                    />
                  </a>
                </li>
                <li>
                  <a
                    href="http://jspang.com/"
                    target="_blank"
                    style="font-size: 1.3em; font-weight: 600; color: #1e90ff"
                    >技术胖</a
                  >
                </li>
                <li>
                  <a href="https://study.163.com" target="_blank">
                    <img
                      ...
                      src="https://edu-image.nosdn.127.net/51373455cc3e4a96a802e89387cb868c.png?imageView&quality=100"
                    />
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="https://edu.csdn.net/" target="_blank">
                    <img
                      ...
                      title="CSDN学院"
                      alt="CSDN学院"
                      style="height: 33px; width: 94px"
                      src="https://ftp.bmp.ovh/imgs/2019/11/671d4a1c07fb8d0c.png"
                    />
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="http://www.jikexueyuan.com/" target="_blank">
                    <img
                      ...
                      title="极客学院"
                      alt="极客学院"
                      src="https://www.jiker.com/_nuxt/img/f43b9a4.svg"
                    />
                  </a>
                </li>
                <li>
                  <a href="https://leetcode-cn.com/" target="_blank">
                    <img
                      ...
                      alt="力扣"
                      style="width: 100px"
                      src="https://static.leetcode-cn.com/cn-mono-assets/production/head/17df28f35bfb3292fe5bdd94b81fa456.svg"
                    />
                  </a>
                </li>
                <li>
                  <a href="http://www.itdks.com/" target="_blank">
                    <img
                      target="_blank"
                      title="IT大咖说"
                      alt="IT大咖说"
                      style="width: 120px"
                      src="http://www.itdks.com/Public/Home/img/customer/logo_index.png"
                    />
                  </a>
                </li>
                <li>
                  <a href="https://edu.51cto.com" target="_blank">
                    <img
                      ...
                      alt="51CTO学院"
                      style="width: 160px"
                      src="https://ftp.bmp.ovh/imgs/2019/11/79a3050c4213f37e.png"
                    />
                  </a>
                </li>
                <li>
                  <a href="https://kaiwu.lagou.com/" target="_blank">
                    <img
                      ...
                      alt="拉勾教育"
                      style="width: 40px"
                      src="http://myimgcloud.oss-cn-hangzhou.aliyuncs.com/blogAssert/lagoujiaoyu.png"
                    />
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="https://www.boxuegu.com/" target="_blank">
                    <img
                      ...
                      alt="博学谷"
                      style="width: 113px"
                      src="https://s1.ax1x.com/2020/03/16/8tEEL9.png"
                    />
                  </a>
                </li>
                <li>
                  <a
                    ...
                    target="_blank"
                    style="background: #3d444c; padding: 5px"
                  >
                    <img
                      target="_blank"
                      title="牛客网"
            ...
            <div class="content-mode">
              ...
              <ul class="siteicon likeassert-list">
                ...
                <li>
                  <a href="https://zh.javascript.info/" target="_blank">
                    <img
                      ...
                      "
                      src="https://zh.javascript.info/img/favicon/favicon.png"
                    />
                    现代 JavaScript 教程
                  </a>
                </li>
                <li>
                  ...
                  >
                    <img
                      ...
                      "
                      src="https://cloud.tencent.com/favicon.ico"
                    />
                    开发者手册
                  </a>
                </li>
                <li>
                  <a
                    href="http://naotu.baidu.com/file/11338e6e28270e427bfb738519e7cc8e?token=16023c01a2b5c4b8"
                    target="_blank"
                  >
                    <svg
                      style="vertical-align: middle"
                ...
                <li>
                  <a href="https://es6.ch-un.com" target="_blank">
                    <img
                      src="http://es6.ruanyifeng.com/favicon.ico"
                      style="
                        width: 16px;
                        display: inline;
                        vertical-align: text-top;
                ...
                <li>
                  <a
                    href="https://www.kancloud.cn/dunizb/web-dev-marrow"
                    target="_blank"
                  >
                    <svg
                      style="vertical-align: middle"
                    ...
                    >
                      <path
                        d="M852.002 1000.016H249.208V171.175h263.721v343.779l133.406-101.323 130.317 101.323V171.175h150.699v753.492c0 41.573-33.775 75.347-75.349 75.347zM646.335 364.259l-95.73 75.348V133.501h188.371v306.106l-92.641-75.348zM136.186 95.827v37.674c0 20.825 16.849 37.676 37.673 37.676h37.676v828.841h-37.676c-41.647 0-75.347-33.774-75.347-75.348V95.828c0-41.647 33.7-75.348 75.347-75.348h678.143c27.814 0 51.802 15.233 64.901 37.674H173.859c-20.825 0-37.673 16.85-37.673 37.674z"
                        fill="#50D2C2"
                        p-id="6871"
                      />
                    </svg>
                ...
                <li>
                  <a
                    href="https://wild-flame.github.io/guides/"
                    target="_blank"
                  >
                    <svg
                      style="vertical-align: middle"
                    ...
                    >
                      <path
                        d="M673.4 903.5H350.6c-6.4 0-10.1-7.4-8.2-16.3l47.1-223.1c1-4.6 5.4-8.2 9.8-8.2h225.1c4.5 0 8.9 3.7 9.8 8.2l47.1 223.1c2.1 8.9-1.5 16.3-7.9 16.3z"
                        fill="#B9D5EA"
                        p-id="7826"
                      />
                      <path
                        d="M673.4 913.5H350.6c-5.4 0-10.3-2.4-13.8-6.6-4.4-5.5-6-13.4-4.2-21.8L379.8 662c1.9-9.2 10.4-16.2 19.6-16.2h225.1c9.2 0 17.7 6.9 19.6 16.2l47.1 223.1c1.8 8.4 0.2 16.3-4.2 21.8-3.3 4.2-8.2 6.6-13.6 6.6z m-321.3-20h319.7c0.2-0.8 0.3-2.3-0.1-4.3l-47.1-223.1-0.3-0.3H399.7l-0.4 0.4-47.1 223c-0.4 2-0.3 3.5-0.1 4.3z"
                        fill="#322E63"
                        p-id="7827"
                      />
                      <path
                        d="M885.6 764.4H137.9c-26.4 0-48-21.6-48-48V203c0-26.4 21.6-48 48-48h747.7c26.4 0 48 21.6 48 48v513.4c0 26.4-21.6 48-48 48z"
                        fill="#28B1D5"
                        p-id="7828"
                      />
                      <path
                        d="M885.6 764.4H137.9c-26.4 0-48-21.6-48-48V591h843.7v125.4c0 26.4-21.6 48-48 48z"
                        fill="#198EBC"
                        p-id="7829"
                      />
                      <path
                        d="M597.4 764.4h274.8L262.9 155h-125c-26.4 0-48 21.6-48 48v53.8l507.5 507.6zM386.9 155l546.7 546.7v-77.4L464.4 155z"
                        fill="#FFFFFF"
                        p-id="7830"
                      />
                      <path
                        d="M885.6 774.4H137.9c-32 0-58-26-58-58V203c0-32 26-58 58-58h747.7c32 0 58 26 58 58v513.4c0 31.9-26 58-58 58zM137.9 165c-21 0-38 17-38 38v513.4c0 21 17 38 38 38h747.7c21 0 38-17 38-38V203c0-21-17-38-38-38H137.9z"
                        fill="#322E63"
                        p-id="7831"
                      />
                      <path
                        d="M885.6 763.7H137.9c-26.4 0-48-21.6-48-48v-72.1h843.7v72.1c0 26.4-21.6 48-48 48z"
                        fill="#FFFFFF"
                        p-id="7832"
                      />
                      <path
                        d="M885.6 774.4H137.9c-32 0-58-26-58-58v-82.1h863.7v82.1c0 31.9-26 58-58 58zM99.9 654.3v62.1c0 21 17 38 38 38h747.7c21 0 38-17 38-38v-62.1H99.9z"
                        fill="#322E63"
                        p-id="7833"
                      />
                      <path
                        d="M512 707.1m-19.4 0a19.4 19.4 0 1 0 38.8 0 19.4 19.4 0 1 0-38.8 0Z"
                        fill="#322E63"
                        p-id="7834"
                      />
                      <path
                        d="M738.6 913.5H285.3c-5.5 0-10-4.5-10-10s4.5-10 10-10h453.3c5.5 0 10 4.5 10 10s-4.4 10-10 10z"
                        fill="#322E63"
                        p-id="7835"
                      />
                    </svg>
                  ...
                  <a href="https://jsrun.pro/" target="_blank">
                    <img
                      style="
                        ...
                        vertical-align: text-top;
                      "
                      src="https://i.loli.net/2019/12/05/dcBCnxfgM7R21Hm.jpg"
                    />
                    JSRUN
                  </a>
                </li>
                  ...
                  <a href="https://regexper.com/" target="_blank">
                    <img
                      style="
                        ...
                        vertical-align: text-top;
                      "
                      src="https://regexper.com/favicon.ico"
                    />
                    Regexper
                  </a>
                </li>
        ...
        <div class="row_box row_likePodcasts">
          ...
          <div class="content">
            <div class="content-items">
              <div class="icon">
                <img
                  src="https://cdn.uigreat.com/5cb76e17-a396-4c5a-8081-a050b343d967.png"
                  alt=""
                  srcset=""
                />
              </div>
            ...
            <div class="content-items">
              <div class="icon">
                <img
                  src="//imagev2.xmcdn.com/group66/M03/C6/67/wKgMdV34M3KDhlePAAWLoNZWEhQ679.jpg!strip=1&quality=7&magick=jpg&op_type=5&upload_type=album&name=mobile_large&device_type=ios"
                  alt=""
                  srcset=""
                />
              </div>
              <div class="info">
                <div class="title">
                  <a href="https://www.ximalaya.com/keji/31769739/"
                    >少数派播客</a
                  >
                </div>
                <div class="desc">
            ...
            <div class="content-items">
              <div class="icon">
                <img
                  src="//imagev2.xmcdn.com/group41/M08/BD/D9/wKgJ8lqan8zg5j15AAXQEYUuLh8384.jpg!strip=1&quality=7&magick=jpg&op_type=5&upload_type=album&name=mobile_large&device_type=ios"
                  alt=""
                  srcset=""
                />
              </div>
            ...
            <div class="content-items">
              <div class="icon">
                <img
                  src="//imagev2.xmcdn.com/group48/M00/7F/E4/wKgKnFtNjDGC1eomAALn_B-zQ3E559.jpg!strip=1&quality=7&magick=jpg&op_type=5&upload_type=album&name=mobile_large&device_type=ios"
                  alt=""
                  srcset=""
                />
              </div>
              <div class="info">
                <div class="title">
                  <a href="https://www.ximalaya.com/gerenchengzhang/9444501/"
                    >36氪·有识芝士</a
                  >
                </div>
                <div class="desc">
            ...
            <div class="content-items">
              ...
              <div class="info">
                <div class="title">
                  <a href="https://www.ximalaya.com/keji/246622/"
                    >原来是这样？！</a
                  >
                </div>
                <div class="desc">
                  愿好奇心长存！不仅仅是冷知识，更是串联各科知识的经纬线！
                </div>
              </div>
            </div>
            <div class="content-items">
              <div class="icon">
                <img
                  src="//imagev2.xmcdn.com/group70/M0A/AA/99/wKgOzl4uwG7SmNwjAAKpHqWpUrQ163.jpg!strip=1&quality=7&magick=webp&op_type=5&upload_type=album&name=mobile_large&device_type=ios"
                  alt=""
                  srcset=""
                />
              </div>
              <div class="info">
                <div class="title">
                  <a href="https://www.ximalaya.com/shangye/32777350/"
                    >硅谷早知道（第四季）</a
                  >
                </div>
                <div class="desc">
      ...
      <div class="row">
        <div class="row_box row_sms">
          ...
          <div class="content grid-50-50 center">
            ...
            <div class="content-item">
              <img
                src="//myimgcloud.oss-cn-hangzhou.aliyuncs.com/blogAssert/ke-chougesha-min.jpeg"
      ...
      <div class="row">
        <div id="rss" class="row_box row_sms">
          ...
          <div class="content">
            <ul class="siteicon">
              <li title="Github">
                <a href="https://github.com/duizb" target="_blank">
                  <i
                    class="iconfont icon-icongithub"
                    style="vertical-align: super; font-size: 2rem"
                  ></i>
                </a>
              </li>
              <li title="segmentfault">
                <a
                  href="https://segmentfault.com/u/dunizb"
                  target="_blank"
                  style="width: 140px"
                >
              ...
              <li title="掘金">
                <a
                  href="https://juejin.im/user/5794cec91532bc0060caf52b"
                  target="_blank"
                >
                  <img
                    src="https://gold-cdn.xitu.io/images/app/logo.png"
                    style="width: 40px"
                  />
                </a>
              </li>
              <li title="腾讯云+社区">
                <a
                  href="https://cloud.tencent.com/developer/column/83987"
                  target="_blank"
                >
                  <img
                    src="https://i.loli.net/2020/01/01/V72IreGcwl36ijC.jpg"
                    style="width: 64px"
                  />
                </a>
              </li>
              <li title="微博">
                <a
                  class="weibo"
                  href="http://www.weibo.com/duni/"
                  target="_blank"
                >
                  <img
                    src="../../../public/images/icon/weibo_1.png"
                    style="width: 40px"
                  />
                </a>
              </li>
              <li title="豆瓣">
                <a
                  class="douban"
                  href="https://www.douban.com/people/dunish/"
                  target="_blank"
                >
                  <img
            ...
            <ul class="qrcode">
              ...
              <li style="width: 390px">
                <img
                  src="//myimgcloud.oss-cn-hangzhou.aliyuncs.com/blogAssert/subscribe6.png"
                  loading="lazy"
                />
              </li>
            </ul>
          ...
          <div class="content">
            ...
            <div class="row_btn">
              <a
                ...
                "
                href="https://dunizb.github.io/footprint"
                target="_blank"
              >
    ...
    <footer>
      <div>
        <div class="service">
          <a
            class="coding"
            title="由Coding.net提供静态Pages"
            href="https://pages.coding.me"
            target="_blank"
          >
            <img
              src="https://dn-coding-net-production-static.qbox.me/static/f7272a0b7cd340571725c6734c6bdd6f.png"
            />
          </a>
        ...
        <div class="m">
          <p>
            Powerd by
            <a href="https://hexo.io/" target="_blank">Hexo</a> & Design by
            <a href="https://zhangbing.site/" target="_blank">张兵</a>
          </p>
        </div>
      </div>
